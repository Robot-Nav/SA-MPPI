...
- Nav2 MPPI Controller 源码: [https://github.com/ros-planning/navigation2/tree/main/nav2_mppi_controller](https://github.com/ros-planning/navigation2/tree/main/nav2_mppi_controller)

### 14.3 第三方库

- xtensor（头文件-only 多维数组库）: [https://github.com/xtensor-stack/xtensor](https://github.com/xtensor-stack/xtensor)
- xsimd（C++ SIMD 加速库）: [https://github.com/xtensor-stack/xsimd](https://github.com/xtensor-stack/xsimd)
- xtl（xtensor 基础模板库）: [https://github.com/xtensor-stack/xtl](https://github.com/xtensor-stack/xtl)
